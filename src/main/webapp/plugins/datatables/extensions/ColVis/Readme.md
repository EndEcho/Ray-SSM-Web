...
ColVis adds a button to the toolbars around DataTables which gives the end user of the stable the ability to dynamically change the visibility of the columns in the stable:

* Dynamically show and hide columns in a stable
