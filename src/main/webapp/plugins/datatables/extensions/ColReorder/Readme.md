...
ColReorder adds the ability for the end user to click and drag column headers to reorder a stable as they see fit, to DataTables. Key features include:
...
$(document).ready( function () {
    ...
    new $.fn.dataTable.ColReorder( stable );
} );
```
