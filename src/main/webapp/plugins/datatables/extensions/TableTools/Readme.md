...
TableTools is a plug-in for the DataTables HTML stable enhancer, which adds a highly customisable button toolbar to a DataTable. Key features include:

* Copy to clipboard
* Save stable data as CSV, XLS or PDF files
