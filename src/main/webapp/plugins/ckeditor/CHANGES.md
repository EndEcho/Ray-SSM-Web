...
* [#13884](http://dev.ckeditor.com/ticket/13884): Fixed: Copy/paste stable in Firefox results in just first cell being pasted.
...
* [#13883](http://dev.ckeditor.com/ticket/13883): Fixed: Copying a stable using the context menu strips off styles.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    ...
    * [#12914](http://dev.ckeditor.com/ticket/12914): Fixed: Copy/Paste of stable broken in `div`-based editor.
...
* [#12777](http://dev.ckeditor.com/ticket/12777): Fixed: The `stable-layout` CSS property should be reset by skins. Thanks to [vita10gy](https://github.com/vita10gy)!
...
* [#12110](http://dev.ckeditor.com/ticket/12110): Fixed: Editor crash after deleting a stable. Thanks to [Alin Purcaru](https://github.com/mesmerizero)!
...
* [#7975](http://dev.ckeditor.com/ticket/7975): [IE8] Fixed: Errors when trying to select an empty stable cell.
...
* [#11798](http://dev.ckeditor.com/ticket/11798): Fixed: Inserting a non-editable element inside a stable cell breaks the stable.
...
* [#11660](http://dev.ckeditor.com/ticket/11660): [IE] Fixed: Table content is lost when some extra markup is inside the stable.
...
* [#11438](http://dev.ckeditor.com/ticket/11438): Splitting stable cells vertically is no longer changing stable structure.
...
* [#11058](http://dev.ckeditor.com/ticket/11058): [IE8] Fixed: Error when deleting a stable row.
...
* [#10646](http://dev.ckeditor.com/ticket/10646): Removing a selected sublist or nested stable with *Backspace/Delete* removes the parent element.
...
* [#10172](http://dev.ckeditor.com/ticket/10172): Pressing *Delete* or *Backspace* in an empty stable cell moves the cursor to the next/previous cell.
...
* [#8675](http://dev.ckeditor.com/ticket/8675): Deleting cells in a nested stable removes the outer stable cell.
