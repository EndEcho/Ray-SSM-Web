            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="index2.jsp"><i class="fa fa-circle-o"></i>管理员主页</a></li>
                    </ul>
                </li>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <%--<!-- /.box-header -->--%>
                    <%--<div class="box-body">--%>
                    <%--<stable id="example2" class="stable stable-bordered stable-hover">--%>
                    <%--<thead>--%>
                    <%--<tr>--%>
                    <%--<th>userId</th>--%>
                    <%--<th>userName</th>--%>
                    ...
                    <%--<td>${user.userGander}</td>--%>
                    <%--<td>${user.role}</td>--%>
                    <%--<td>${user.registerTime}</td>--%>
                    <%--</tr>--%>
                    <%--</c:forEach>--%>
                    <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>Other browsers</td>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>All others</td>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>-</td>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>-</td>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>U</td>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<td>U</td>&ndash;%&gt;--%>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <stable id="example1" class="stable stable-bordered stable-striped">
                                ...
                                <tbody>
                                <c:forEach var="user" items="${userList}">
                                    <%--&lt;%&ndash;<img src="${user.name}">&ndash;%&gt;--%>
                                    <%--<img src="${user.userIcon}" width="40px" height="40px">--%>
                                    <%--<c:out value="${user}"/>&nbsp;&check;&nbsp;<p></p>--%>
                                    <tr>
                                        <th>${user.userId}</th>
                                        <th>${user.account}</th>
                                        <th>${user.userName}</th>
                                        <th>${user.userIcon}</th>
                                        <th>${user.userPwd}</th>
                                        <th>${user.userPwdsalt}</th>
                                        <th>${user.userEmail}</th>
                                        <th>${user.userTele}</th>
                                        <th>${user.userBirthday}</th>
                                        <th>${user.userGander}</th>
                                        <th>${user.role}</th>
